1 Git Installation
                                                  ========= Download Git from the website: https://www.gitscm.com/
2 Command line
...
"test@w3schools.com"
                                                                       Configure Git
                                                                  Change the user name and e-mail address to your 
                                                                               own
4 >mkdir myproject
...
9 >git commit -m "First release 
of Hello World!"                                                  The committ command performs a commit, and the -m "message" adds a message.

10> git commit -a -m "Updated 
index.html with a new line"                                                                                                Skips staging environment
...
15 >git branch hello-world-images
 
                                                                    a branch is a new/separate version of the main repository. This command 

16 >git checkout hello-world-images                                                        checkout is the command used to check out/ move to  branch

17 >git checkout master                                                                    sed to switch between branches
...
master                                                                                                             push master branch to the origin url,

22                                                                                          go back into GitHub and see that the repository has been updated:

23 git fetch origin                                                                                                          fetch gets all the change history 
24 git merge origin/master
                                                                       merge combines the current branch, with a specified branch.

25 git pull origin                                                    pull is a combination of fetch and mergeIt is used to pull all changes from a remote repository 
